...
declare module '@nuxt/schema' {
  interface RuntimeConfig {
    apiParty: {
      endpoints: NonNullable<ModuleOptions['endpoints']>
    }
  }
...
`.trimStart()
    ...
    addConfigScript({
      basename: `module/${name}.config`,
      config: {
        // Options that shouldn't be changed during production
        allowClient: options.client ?? false,
        serverBasePath: options.server.basePath,
      ...
      types: {
        allowClient: {
          ...
          types: [
            ...
            { type: 'TSLiteralType', literal: { type: 'StringLiteral', value: 'allow' } },
            { type: 'TSLiteralType', literal: { type: 'StringLiteral', value: 'always' } },
          ],
        },
      },
    })
