...
> [!WARNING]
> In order to use this plugin, you need to set the API Party option `server.proxyMode` to `'passthrough'`. Due to how clients implement redirects, supporting the wrapped proxy is not possible.
